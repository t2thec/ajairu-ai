...
async function sendQuizResultsEmail(toEmail, score, verdict, categoryScores) {
  ...
  await transporter.sendMail({
    ...
    text: `Your AI Readiness Score: ${score}/100\n\n${verdict}\n\nBreakdown:\n${categories.map(c => `${c.name}: ${c.score}/100`).join('\n')}\n\nWant to go deeper? Our AI Opportunity Audit (from £750) examines your actual operations and gives you a prioritised report with ROI estimates. Book a free call: https://ajairu.ai/contact\n\n${emailConfig.fromName}`,
    html: `<!DOCTYPE html>
<html>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="background:#e8f8f5;border-radius:10px;border:1px solid #00a88e;">
              <tr>
                <td style="padding:24px;text-align:center;">
                  ...
                  <a href="https://ajairu.ai/contact" style="display:inline-block;background:#00a88e;color:#ffffff;text-decoration:none;font-weight:700;font-size:14px;padding:14px 32px;border-radius:8px;">Book a Free Discovery Call</a>
                </td>
              </tr>
            </table>
          </td>
...
async function sendGuideEmail(toEmail) {
  ...
  await transporter.sendMail({
    from: `"${emailConfig.fromName}" <${emailConfig.fromEmail}>`,
    to: toEmail,
    subject: 'Your Free Guide: 5 AI Use Cases That Pay for Themselves in 90 Days',
    text: `Here is your free guide: 5 AI Use Cases That Pay for Themselves in 90 Days.\n\n1. Customer Enquiry Triage and Response - 60-80% of enquiries get a first response in seconds\n2. Invoice and Document Processing - 70% reduction in processing time\n3. Meeting Notes and Action Item Capture - 3-5 hours saved per person per week\n4. Content Drafting for Marketing - 50-70% reduction in content creation time\n5. Internal Knowledge Base and Search - 50% reduction in time spent searching\n\nWant help implementing any of these? Book a free discovery call: https://ajairu.ai/contact\n\n${emailConfig.fromName}`,
    html: `<h2>Your Free Guide: 5 AI Use Cases That Pay for Themselves in 90 Days</h2><ol><li><strong>Customer Enquiry Triage and Response</strong> - 60-80% of enquiries get a first response in seconds</li><li><strong>Invoice and Document Processing</strong> - 70% reduction in processing time</li><li><strong>Meeting Notes and Action Item Capture</strong> - 3-5 hours saved per person per week</li><li><strong>Content Drafting for Marketing</strong> - 50-70% reduction in content creation time</li><li><strong>Internal Knowledge Base and Search</strong> - 50% reduction in time spent searching</li></ol><p>Want help implementing any of these? <a href="https://ajairu.ai/contact">Book a free discovery call</a>.</p><p>${emailConfig.fromName}</p>`,
  });
}
