// Branded HTML email template for ajairu.ai
...
const BRAND = {
  ...
  domain: 'ajairu.ai',
  url: 'https://ajairu.ai',
  contactUrl: 'https://ajairu.ai/contact',
  privacyUrl: 'https://ajairu.ai/privacy',
  navy: '#1a2332',
  accent: '#00c4a7',
  accentLight: '#ccfbef',
  accentDark: '#00a88e',
  email: 'hello@ajairu.ai',
  tagline: 'AI consulting for UK SMEs',
};

// Inline SVG hexagon logo as a data URI (base64)
...
<body style="margin:0;padding:0;background:#f0fdfa;font-family:'Open Sans',Arial,sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;">

<!-- Preview text hidden -->
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#f0fdfa;padding:24px 0;">
<tr>
<td align="center">

<!-- Outer container -->
<table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:600px;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #ccfbef;">
...
<!-- Footer -->
<tr>
<td style="background:#f8fdfb;border-top:1px solid #ccfbef;padding:24px 40px;">
<table width="100%" cellpadding="0" cellspacing="0" border="0">
<tr>
...
<a href="${BRAND.url}" style="color:${BRAND.accentDark};text-decoration:none;">${BRAND.domain}</a>
&nbsp;|&nbsp;
<a href="${BRAND.contactUrl}" style="color:${BRAND.accentDark};text-decoration:none;">Contact</a>
&nbsp;|&nbsp;
<a href="${BRAND.privacyUrl}" style="color:${BRAND.accentDark};text-decoration:none;">Privacy</a>
</p>
...
${contentHtml}
<p style="margin:16px 0 0;padding:12px 16px;background:#f0fdfa;border-radius:6px;font-family:Arial,sans-serif;font-size:11px;color:#94a3b8;line-height:1.5;">This is an internal notification from the ${BRAND.domain} website.</p>`;
}
